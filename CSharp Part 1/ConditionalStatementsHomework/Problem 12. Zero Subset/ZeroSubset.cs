...
class ZeroSubset
{
    static void Main()
    {
        Console.WriteLine("This program finds all subsets of five given integer numbers whose sum is 0.");
        ...
        Console.Write("Please enter fourth integer number: ");
        int d = Int32.Parse(Console.ReadLine());
        Console.Write("Please enter fifth integer number: ");
