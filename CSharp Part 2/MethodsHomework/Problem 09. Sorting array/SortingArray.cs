...
class SortingArray
{
    static void Main()
    {
        Console.WriteLine("This program return the maximal element in a portion of array of integers " +
                          "starting at given index and sorts an array both in ascending / descending order.");
