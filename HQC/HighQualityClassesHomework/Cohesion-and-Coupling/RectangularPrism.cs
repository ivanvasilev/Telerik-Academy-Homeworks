    ...
    public class RectangularPrism
    {
        ...
        public double Width
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException(RectangularPrism.InvalidWidthExceptionMessage);
                }
        ...
        public double Height
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException(RectangularPrism.InvalidHeightExceptionMessage);
                }
        ...
        public double Depth
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException(RectangularPrism.InvalidDepthExceptionMessage);
                }
